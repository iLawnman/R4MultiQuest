...
{
        [Header("-- Main Back")] 
        [SerializeField] private SpriteRenderer _mainBackImg1;
        [SerializeField] private SpriteRenderer _mainBackImg2;

        [Header("-- Title")] 
        [SerializeField] private SpriteRenderer _titleBackImg;
        [SerializeField] private GameObject _titleBackEmptyImg;
        [SerializeField] private TMP_Text _title;

        [Header("-- Main Text")] 
        [SerializeField] private GameObject _2lineImg;
        ...
        [Header("-- Additional")] 
        [SerializeField] private Image _additionalImg;

        [Header("Right Panel")] 
        [SerializeField] private GameObject _rightEmptyImg;

        [SerializeField] private GameObject _rightDecorImg;
        [SerializeField] private SpriteRenderer _rightBackImg;

        [Header("-- Left Panel")] 
        [SerializeField] private GameObject _leftEmptyImg;
        ...
        [SerializeField] private SpriteRenderer _buttonsBackImg;

        [Header("-- Slider Panel")] 
        [SerializeField] private GameObject _sliderButtons;
        ...
        [Header("-- 4 Buttons Panel")] 
        [SerializeField] private GameObject _4buttons;
        ...
        private void FillTexts(BasePrefabTexts txts)
        {
                ...
                if (txts._helpUp != string.Empty || txts._helpDown != string.Empty)
                        OnIfEmptyLeft(false);

                if(txts._title != string.Empty)
                        OnTitleDecor(false);
        }
